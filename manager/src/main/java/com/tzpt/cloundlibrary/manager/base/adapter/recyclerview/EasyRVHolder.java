...
import com.tzpt.cloundlibrary.manager.base.adapter.glide.GlideCircleTransform;
import com.tzpt.cloundlibrary.manager.base.adapter.glide.GlideRoundTransform;
import com.tzpt.cloundlibrary.manager.base.adapter.helper.ViewHelper;
...
public class EasyRVHolder extends RecyclerView.ViewHolder implements ViewHelper.RecyclerView<EasyRVHolder> {
    ...
    @Override
    public EasyRVHolder setText(int viewId, CharSequence value) {
        TextView view = getView(viewId);
        view.setText(value);
        return this;
    }
...
//        GlideApp.with(mContext).load(imgUrl).placeholder(placeHolderRes) .transform(new GlideCircleTransform()).into(view);
    ...
    public EasyRVHolder setRoundImageUrl(int viewId, String imgUrl, int placeHolderRes) {
        ImageView view = getView(viewId);
//        GlideApp.with(mContext).load(imgUrl).placeholder(placeHolderRes) .transform(new GlideRoundTransform()).into(view);
        return this;
    }
