...
//    }
    ...
    public void setCustomMoreView(final int moreRes, final int noMoreRes, final int errorMoreRes, final OnLoadMoreListener listener) {
        FrameLayout moreContainer = new FrameLayout(getContext());
        moreContainer.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        LayoutInflater.from(getContext()).inflate(moreRes, moreContainer);

        FrameLayout noMoreContainer = new FrameLayout(getContext());
        noMoreContainer.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        LayoutInflater.from(getContext()).inflate(noMoreRes, noMoreContainer);

        FrameLayout errorMoreContainer = new FrameLayout(getContext());
        errorMoreContainer.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        LayoutInflater.from(getContext()).inflate(errorMoreRes, errorMoreContainer);

        getEventDelegate().setCustomMoreView(moreContainer, noMoreContainer, errorMoreContainer, listener);
    }

    public void setNullMoreView(final OnLoadMoreListener listener) {
        getEventDelegate().setNullMoreView(listener);
    }
//
