 ...
 */
public class EntranceGuardPresenter extends RxPresenter<EntranceGuardContract.View> implements
        EntranceGuardContract.Presenter,
        BaseResponseCode {

    @Override
    public void getLoginLibraryInfo() {
