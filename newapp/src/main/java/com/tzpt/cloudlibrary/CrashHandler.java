...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        if (null != mDefaultUEHandler) {
            ...
            buffer.append("getErrorInfo==> \n").append(getErrorInfo(ex))
                    ...
                    .append("getErrorTime==> \n").append(DateUtils.getTodayDateTime());
     ...
     * 发送Exception 到我的邮箱
     */
    public void sendEmailToExceptionService(String message) {
        Log.e("message--->", "message--->" + message);
        saveLog(message);
    }

    private void saveLog(String message) {
        SharedPreferencesUtil.getInstance().putString("ytsg_crash_log", message);
    }

    public String getLog() {
        return SharedPreferencesUtil.getInstance().getString("ytsg_crash_log");
    }
