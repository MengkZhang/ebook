package com.tzpt.cloudlibrary.widget.flowlayout;
...
public class FlowLayout extends ViewGroup {
    ...
    private OnLongClickListener mOnLongClickListener = new OnLongClickListener() {
        ...
        public boolean onLongClick(View v) {
            if (null != mListener) {
                ...
                mListener.onFlowLongClickListener(position);
                return true;
            }
            return false;
        }
    ...
    private OnClickListener mOnClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (null != mListener) {
                int position = (int) v.getTag();
                mListener.onFlowClickListener(position);
            }
        }
    };
    ...
    private FlowClickListener mListener;

    public void setOnFlowClickListener(FlowClickListener listener) {
        this.mListener = listener;
    }

    public interface FlowClickListener {

        void onFlowClickListener(int position);

        void onFlowLongClickListener(int position);
    }
}
