...
//    }
     ...
     * @param object The object to add at the index of the array.
     */
    public void add(int index, T object) {
        ...
        if (mObserver != null)
            mObserver.onItemRangeInserted(index + 1, 1);
        if (mNotifyOnChange)
     ...
     *
     * @param index      the index of the array
     * @param collection The Collection to add at the index of the array.
     */
    ...
    public void insertAll(T[] object, int index) {
        ...
        if (mObserver != null)
            mObserver.onItemRangeInserted(index + 1, dataCount);
        if (mNotifyOnChange)
     ...
     * 删除，不会触发任何事情
     *
     * @param index      from the index of the array
     * @param collection The objects to remove.
     */
    public void removeAll(int index, Collection<? extends T> collection) {
        synchronized (mLock) {
            if (mObjects.removeAll(collection)) {
//                notifyItemChanged(index - 1);
//                notifyItemRangeRemoved(index, collection.size());
                notifyDataSetChanged();
//                if (mObserver != null) mObserver.onItemRangeRemoved(index, collection.size());
//                if (mNotifyOnChange)
//                    notifyItemRangeChanged(headers.size() + index, collection.size());
            }
        }
    }
