...
public class LoopViewPager extends ViewPager {
    ...
    private static final int DELAY_LONG_DUTATION = 4000;
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper()) {
        public void handleMessage(android.os.Message msg) {
            if (mIsLoopPicture && mAdapter != null && mAdapter.getCount() > 0) {
...
//        loopPictureIfNeed();
    ...
    private OnPageChangeListener onPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (mDispatchListener != null) {
                mDispatchListener.onPageChanged(realPosition, mAdapter.getRealCount());
            }
        }
    ...
    public static interface OnDispatchTouchEventListener {
        ...
        void onPageChanged(int realPosition, int realCount);
    }
    ...
    public void releaseLoopPicHandler() {
        mHandler.removeMessages(MSG_LOOP_PICTURE);
    }
}
