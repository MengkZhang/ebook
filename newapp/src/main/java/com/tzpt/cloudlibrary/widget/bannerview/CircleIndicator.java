...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.mipmap.ic_banner_select;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.bg_00000000;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.mipmap.ic_banner_select, R.drawable.bg_00000000);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.mipmap.ic_banner_select
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
                (mIndicatorUnselectedBackgroundResId == 0) ? R.drawable.bg_00000000
                        : mIndicatorUnselectedBackgroundResId;
    }
    ...
    private void addIndicator(@DrawableRes int backgroundDrawableId, Animator animator) {
        ...
        lp.leftMargin = mIndicatorMargin > 0 ? mIndicatorMargin : 0;
        lp.rightMargin = mIndicatorMargin > 0 ? mIndicatorMargin : 0;
