package com.tzpt.cloudlibrary.base.adapter.recyclerview;
...
import com.tzpt.cloudlibrary.base.adapter.helper.ViewHelper;
...
public class EasyRVHolder extends RecyclerView.ViewHolder implements ViewHelper.RecyclerView<EasyRVHolder> {
    ...
    public EasyRVHolder setTextSize(int viewId, float value) {
        TextView view = getView(viewId);
    ...
    public EasyRVHolder setImageUrl(int viewId, String imgUrl, int placeHolderRes) {
        ImageView view = getView(viewId);
        GlideApp.with(mContext).load(imgUrl).placeholder(placeHolderRes).centerCrop().into(view);
        return this;
    }

    public EasyRVHolder setImageUrl(int viewId, String imgUrl, int placeHolderRes, int errorRes) {
        ImageView view = getView(viewId);
        GlideApp.with(mContext).load(imgUrl).placeholder(placeHolderRes).error(errorRes).centerCrop().into(view);
        return this;
    }

    public EasyRVHolder setImageUrl(int viewId, int errorId, String imgUrl) {
        ImageView view = getView(viewId);
    ...
    public EasyRVHolder setCompoundLeftDrawables(int viewId, Drawable drawable) {
        TextView view = getView(viewId);
        view.setCompoundDrawablesWithIntrinsicBounds(drawable, null, null, null);
        return this;
    }

    public EasyRVHolder setCompoundRightDrawables(int viewId, Drawable drawable) {
        TextView view = getView(viewId);
