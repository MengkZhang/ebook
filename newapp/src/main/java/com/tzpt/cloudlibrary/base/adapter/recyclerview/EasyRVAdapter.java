...
import com.tzpt.cloudlibrary.base.adapter.helper.DataHelper;
...
public abstract class EasyRVAdapter<T> extends RecyclerView.Adapter<EasyRVHolder> implements DataHelper<T> {
    ...
    private OnRvItemClickListener<T> mItemClickListener;

    private SparseArray<View> mConvertViews = new SparseArray<>();

    public EasyRVAdapter(Context context, int... layoutIds) {
    ...
    public EasyRVHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final EasyRVHolder finalViewHolder = viewHolder;
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mItemClickListener != null) {
                    mItemClickListener.onItemClick(finalViewHolder.getAdapterPosition(), getItem(finalViewHolder.getAdapterPosition()));
                }
            }
        });
        return viewHolder;
    ...
    public void setOnItemClickListener(OnRvItemClickListener<T> listener) {
