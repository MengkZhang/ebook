...
/**
 * Created by tonyjia on 2018/12/25.
 */
...
public class RoundedCornersTransformation extends BitmapTransformation {
    ...
    private static final String ID = "com.tzpt.cloudlibrary.base.adapter.glide.RoundedCornersTransformation." + VERSION;
    ...
    @Override
    public int hashCode() {
        return ID.hashCode() + (int) mRadius * 10000 + (int) mDiameter * 1000 + mMargin * 100 + mCornerType.ordinal() * 10;
    }

    @Override
    public void updateDiskCacheKey(@NonNull MessageDigest messageDigest) {
        messageDigest.update((ID + mRadius + mDiameter + mMargin + mCornerType).getBytes(CHARSET));
    }
}
