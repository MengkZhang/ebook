 ...
 */
public class InformationHomeAdapter extends EasyRVAdapter<InformationBean> {
    ...
    @Override
    protected void onBindData(EasyRVHolder holder, int position, InformationBean item) {
