...
public class DepositBalanceAdapter extends RecyclerArrayAdapter<DepositBalanceBean> {

    public DepositBalanceAdapter(Context context) {
        super(context);
    }
        ...
        return new BaseViewHolder<DepositBalanceBean>(parent, R.layout.view_item_deposit_balance) {
            ...
            public void setData(DepositBalanceBean item) {
                holder.setText(R.id.deposit_balance_name_tv, item.mName)
                        ...
                        .setText(R.id.occupy_deposit_tv, MoneyUtils.formatMoney(item.mOccupyDeposit));
