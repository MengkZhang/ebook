 ...
 */
public class LibraryAdapter extends RecyclerArrayAdapter<LibraryBean> {
...
//    private Drawable mLightOffDrawable;
    ...
    public LibraryAdapter(Context context, boolean showStatus, boolean recommendNewBook) {
        super(context);
...
//        mLightOffDrawable.setBounds(0, 0, mLightOffDrawable.getMinimumWidth(), mLightOffDrawable.getMinimumHeight());
    ...
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        return new BaseViewHolder<LibraryBean>(parent, R.layout.view_item_library) {
            @Override
...
//                    }
                    ...
                    //是否展示图书馆内的图书状态
                    if (mShowStatus) {
                        setVisible(R.id.library_status_tv, View.VISIBLE);
                        ...
                        holder.setText(R.id.library_status_tv, mLibInfoBuffer.toString());
                    }

                    //设置推荐新书图书馆信息
                    if (mRecommendNewBook) {
                        holder.setVisible(R.id.library_recommend_book_flag_tv, item.recommendExist == 1 ? View.VISIBLE : View.GONE);
                    }
                }
            }
        };
