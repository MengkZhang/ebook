 ...
 */
public class LibraryDetailFragment extends BaseFragment implements
        LibraryDetailContract.View {
    ...
    private LibraryDetailContract.Presenter mPresenter;
    ...
    public void onViewClicked(View v) {
        switch (v.getId()) {
            ...
            case R.id.banner_default_img:
                mPresenter.getLibNewsList();
                break;
            case R.id.lib_introduce_fl:
                LibraryIntroduceActivity.startActivity(getSupportActivity(), mLibraryBean.mLibrary, mLibraryBean.mDistance, mLibraryBean.mIsValidLngLat, mPresenter.getFromSearch());
                break;
        }
    }
            ...
            if (data.mIsBaseModel) {
                switch (data.mId) {
                    case 0://本馆介绍
                        ...
                        break;
                    case 1://总分馆
                        LibraryMainBranchActivity.startActivity(getSupportActivity(), mPresenter.getLibraryCode());
                        break;
                    case 2://图书
                        BookTabActivity.startActivityFromLib(getSupportActivity(), mPresenter.getLibraryCode(), "本馆图书");
                        break;
                    case 3://电子书
                        EBookTabActivity.startActivityFromLib(getSupportActivity(), mPresenter.getLibraryCode(), "本馆电子书");
                        break;
                    case 4://视频
                        VideoTabActivity.startActivity(getSupportActivity(), mPresenter.getLibraryCode(), "本馆视频");
                        break;
                    case 5://活动
                        ActivityListActivity.startActivity(getSupportActivity(), mPresenter.getLibraryCode(), "本馆活动");
                        break;
                    case 6://资讯
                        InformationActivity.startActivity(getSupportActivity(), mPresenter.getLibraryCode(), "本馆资讯");
                        break;
                    case 7://读者留言
                        LibraryMessageBoardActivity.startActivity(getSupportActivity(), mPresenter.getLibraryCode(), "读者留言");
                        break;
                    case 8://借阅须知
                        BorrowingIntroduceActivity.startActivity(getSupportActivity(), mPresenter.getLibraryCode());
                        break;
                }
            } else {
    ...
    public void showLibraryInfo(LibraryBean libInfo) {
        ...
        mLibIntroduceView.setLibDistance(mLibraryBean.mDistance);
        mLibIntroduceView.setAddress(mLibraryBean.mLibrary.mAddress);
    ...
    public void setPaperBookList(List<BookBean> paperBookBeanList, int totalCount) {
        if (mLibPaperBookIv == null) {
            ...
            mLibPaperBookIv.setRecyclerViewMargin(DpPxUtils.dp2px(12), 0, DpPxUtils.dp2px(12), 0);
        ...
        if (mLibEBookIv == null) {
            ...
            mEBookAdapter.setOnItemClickListener(new OnRvItemClickListener<EBookBean>() {
                ...
                public void onItemClick(int position, EBookBean data) {
                    if (data != null) {
                        EBookDetailActivity.startActivity(getSupportActivity(), String.valueOf(data.mEBook.mId), mPresenter.getLibraryCode());
                    }
                }
            });
        ...
        if (mLibVideoIv == null) {
            ...
            mVideoListAdapter.setOnItemClickListener(new OnRvItemClickListener<VideoSetBean>() {
                ...
                public void onItemClick(int position, VideoSetBean data) {
                    if (data != null) {
                        VideoDetailActivity.startActivity(getSupportActivity(), data.getId(), data.getTitle(), mPresenter.getLibraryCode());
                    }
                }
            });
