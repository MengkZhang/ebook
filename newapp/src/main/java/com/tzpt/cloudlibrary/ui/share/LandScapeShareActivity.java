 ...
 * 分享
 */
public class LandScapeShareActivity extends AppCompatActivity implements ShareAppContract.View {
    ...
    public static void startActivityForResult(Activity activity, ShareBean shareBean, int requestCode) {
        Intent intent = new Intent(activity, LandScapeShareActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_land_scape_share);
    ...
    private void configViews() {
        setScreenFull();
        mShareRecyclerView.setLayoutManager(new GridLayoutManager(this, 4));
        mAdapter = new ShareAdapter(this, true);
