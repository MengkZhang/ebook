...
//JavaClass AndroidUtil::Class_ZLibrary("com/tzpt/cloudlibrary/zlibrary/core/library/ZLibrary");
JavaClass AndroidUtil::Class_ZLFile("com/tzpt/cloudlibrary/zlibrary/core/filesystem/ZLFile");
//JavaClass AndroidUtil::Class_FileInfo("com/tzpt/cloudlibrary/zlibrary/core/fonts/FileInfo");
//JavaClass AndroidUtil::Class_FileEncryptionInfo("com/tzpt/cloudlibrary/zlibrary/core/drm/FileEncryptionInfo");
JavaClass AndroidUtil::Class_ZLFileImage("com/tzpt/cloudlibrary/zlibrary/core/image/ZLFileImage");
JavaClass AndroidUtil::Class_ZLTextModel("com/tzpt/cloudlibrary/zlibrary/text/model/ZLTextModel");

//JavaClass AndroidUtil::Class_Encoding("com/tzpt/cloudlibrary/zlibrary/core/encodings/Encoding");
JavaClass AndroidUtil::Class_EncodingConverter("com/tzpt/cloudlibrary/zlibrary/core/encodings/EncodingConverter");
//JavaClass AndroidUtil::Class_JavaEncodingCollection("com/tzpt/cloudlibrary/zlibrary/core/encodings/JavaEncodingCollection");

JavaClass AndroidUtil::Class_NativeFormatPlugin("com/tzpt/cloudlibrary/cbreader/formats/NativeFormatPlugin");
//JavaClass AndroidUtil::Class_PluginCollection("com/tzpt/cloudlibrary/cbreader/formats/PluginCollection");
//JavaClass AndroidUtil::Class_Paths("com/tzpt/cloudlibrary/cbreader/Paths");
JavaClass AndroidUtil::Class_AbstractBook("com/tzpt/cloudlibrary/cbreader/book/AbstractBook");
JavaClass AndroidUtil::Class_Book("com/tzpt/cloudlibrary/cbreader/book/Book");
JavaClass AndroidUtil::Class_Tag("com/tzpt/cloudlibrary/cbreader/book/Tag");
JavaClass AndroidUtil::Class_BookModel("com/tzpt/cloudlibrary/cbreader/bookmodel/BookModel");
...
bool AndroidUtil::init(JavaVM* jvm) {
	...
	//Constructor_FileInfo = new Constructor(Class_FileInfo, "(Ljava/lang/String;Lcom/tzpt/cloudlibrary/zlibrary/core/drm/FileEncryptionInfo;)V");
	...
	Constructor_ZLFileImage = new Constructor(Class_ZLFileImage, "(Lcom/tzpt/cloudlibrary/zlibrary/core/filesystem/ZLFile;Ljava/lang/String;[I[ILcom/tzpt/cloudlibrary/zlibrary/core/drm/FileEncryptionInfo;)V");
	...
	//Method_Book_addTag = new VoidMethod(Class_AbstractBook, "addTag", "(Lcom/tzpt/cloudlibrary/cbreader/book/Tag;)");
	//Method_Book_addUid = new VoidMethod(Class_AbstractBook, "addUid", "(Ljava/lang/String;Ljava/lang/String;)");

	StaticMethod_Tag_getTag = new StaticObjectMethod(Class_Tag, "getTag", Class_Tag, "(Lcom/tzpt/cloudlibrary/cbreader/book/Tag;Ljava/lang/String;)");
	...
	Method_BookModel_setBookTextModel = new VoidMethod(Class_BookModel, "setBookTextModel", "(Lcom/tzpt/cloudlibrary/zlibrary/text/model/ZLTextModel;)");
//	Method_BookModel_setFootnoteModel = new VoidMethod(Class_BookModel, "setFootnoteModel", "(Lcom/tzpt/cloudlibrary/zlibrary/text/model/ZLTextModel;)");
	Method_BookModel_addImage = new VoidMethod(Class_BookModel, "addImage", "(Ljava/lang/String;Lcom/tzpt/cloudlibrary/zlibrary/core/image/ZLImage;)");
//	Method_BookModel_registerFontFamilyList = new VoidMethod(Class_BookModel, "registerFontFamilyList", "([Ljava/lang/String;)");
//	Method_BookModel_registerFontEntry = new VoidMethod(Class_BookModel, "registerFontEntry", "(Ljava/lang/String;Lcom/tzpt/cloudlibrary/zlibrary/core/fonts/FileInfo;Lcom/tzpt/cloudlibrary/zlibrary/core/fonts/FileInfo;Lcom/tzpt/cloudlibrary/zlibrary/core/fonts/FileInfo;Lcom/tzpt/cloudlibrary/zlibrary/core/fonts/FileInfo;)");
...
jstring AndroidUtil::charTojstring(JNIEnv *env, const char *pat) {
