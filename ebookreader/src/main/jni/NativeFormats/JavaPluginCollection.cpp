...
extern "C"
JNIEXPORT jobjectArray JNICALL Java_com_tzpt_cloudlibrary_cbreader_formats_PluginCollection_nativePlugins(JNIEnv* env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL Java_com_tzpt_cloudlibrary_cbreader_formats_PluginCollection_free(JNIEnv* env, jobject thiz) {
